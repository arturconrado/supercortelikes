...
export LLM_MODEL="${LLM_MODEL:-google/gemini-2.5-flash-lite}"
export LLM_PROVIDER_SORT="${LLM_PROVIDER_SORT:-latency}"
export COMPOSITION_V1_ENABLED="${COMPOSITION_V1_ENABLED:-false}"
export COMPOSITION_V1_ROLLOUT_PERCENT="${COMPOSITION_V1_ROLLOUT_PERCENT:-100}"
export MEDIA_ACCELERATOR="${MEDIA_ACCELERATOR:-cpu}"
export FFMPEG_CRF="${FFMPEG_CRF:-19}"
export RENDER_MAX_SOURCE_SHORT_SIDE="${RENDER_MAX_SOURCE_SHORT_SIDE:-1080}"
